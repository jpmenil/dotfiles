;;; jpm-programming.el --- Programming modes (and related)  -*- lexical-binding: t; -*-
...
(use-package cc-mode
  ...
  (defun jpm:openbsd-knf-space-indent (langelem)
...
arglist-cont-nonempty"
  ...
  (c-add-style
   ...
   '(
     ...
     (c-offsets-alist . (
                         ...
                         (arglist-intro . jpm:openbsd-knf-space-indent) ; 1st line
                         (arglist-cont . jpm:openbsd-knf-space-indent)
                         (arglist-cont-nonempty . jpm:openbsd-knf-space-indent)
  ...
  (defun jpm:flycheck-fix-clang-include-path ()
...
(provide 'jpm-programming)
;;; jpm-programming.el ends here
